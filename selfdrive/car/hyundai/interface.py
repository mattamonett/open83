...
class CarInterface(CarInterfaceBase):
    ...
    def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
        ...
        if candidate == CAR.SANTA_FE:
            ...
            ret.wheelbase = 2.7
            # 14 is Stock | Settled Params Learner values are steerRatio: 15.401566348670535
            ret.steerRatio = 15.4
            ...
            ret.lateralTuning.pid.kf = 0.00006
            # weight per hyundai site https://www.hyundaiusa.com/ioniq-electric/specifications.aspx
        ...
        # Kia
            ...
            # ret.lateralTuning.pid.kf = 0.00005
            ret.lateralTuning.init('indi')
            ret.lateralTuning.indi.innerLoopGain = 2.4  # stock is 3.0 but 4.0 seems good
            ret.lateralTuning.indi.outerLoopGain = 3.0  # stock is 2.0.  Trying out 2.5
